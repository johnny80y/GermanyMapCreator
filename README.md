...
This script allows for a quick and easy creation of maps and heat maps for Germany.
This can be useful for reports and visualizations focused on Hessen.
The same code can, of course, be used to create similar maps for any other region in the world.

To create a map, simply open GermanyMapCreator.ipynb in Jupyter Notebook.
